...
require(igraph)
require(htmlwidgets)
entity_id<-read.csv(sprintf('C:/Users/MR38804/Documents/Network Graph/RSME Request/%s/RSME_entity_id.csv',folder))
transfer_id<-read.csv(sprintf('C:/Users/MR38804/Documents/Network Graph/RSME Request/%s/RSME_trans_id.csv',folder))
debtor_id<-read.csv(sprintf('C:/Users/MR38804/Documents/Network Graph/RSME Request/%s/RSME_debtor_id.csv',folder))
...
lnodes<-data.frame(label=c("MBI Out", "MBI In", "MBI Both",
                   ...
                   color=c("black", "black", "black",
                           "black", "black", "black",
                           "#a15c5c", "#977dab", "#5c70a1", "orange", "#ff0000"))
...
result=visNetwork(nodes,edges,main=sprintf('RSME Funding Entities - Cash Flow Graph',folder),
...
htmlwidgets::saveWidget(result,(sprintf('C:/Users/MR38804/Documents/Network Graph/RSME Request/%s/result_%sv1.html',folder,folder)),selfcontained=TRUE)
